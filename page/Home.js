...
const Home = ({ navigation }) => {
  ...
  return (
    <ImageBackground
      source={require("../assets/SignWise_fundo.jpg")}
    ...
    >
      <SafeAreaView style={{ alignItems: "center", justifyContent: "center" }}>
        <View style={styles.logoContainer}>
          <Image
            style={styles.logo}
            source={require("../assets/SignWise_logo.png")}
          />
        ...
        <View style={styles.buttonsContainer}>
          ...
          >
            <View style={styles.button}>
              <Image
                source={require("../assets/translation_icon.png")}
          ...
          <TouchableOpacity
            onPress={() =>
              Linking.openURL("https://spreadthesign.com/pt.pt/search/")
            }
            activeOpacity={0.8}
          >
            <View style={styles.button}>
          ...
          >
            <View style={styles.button}>
              <Image
                source={require("../assets/tutorials_icon.png")}
                style={{
                  width: 45,
                  height: 45,
                  marginRight: 40,
          ...
          >
            <View style={styles.button}>
              <Image
                source={require("../assets/about_u_icon.png")}
                style={{
                  width: 43,
                  height: 43,
                  marginRight: 47,
